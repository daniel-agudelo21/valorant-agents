...
export default function Footer() {
    ...
    return (
        <footer className="hidden md:flex flex-row justify-evenly items-center  w-full text-white/50 bg-[#222121]/55  rounded-lg m-auto shadow-md py-6">
            <h2>© {currentYear} <a href="https://daniel-desarrollo-web.netlify.app/" target="_blank" className="hover:underline hover:text-white">Daniel Agudelo.</a> Casi todos los derechos reservados.</h2>
