    ...
    return (
        <div className="flex flex-col justify-center mx-auto max-w-[1920px]">
            <div className="relative flex justify-center 2lg:h-[900px]">
                ...
                <div className="absolute flex h-full md:h-[450px] lg:h-[635px] 2lg:h-[870px] xl:h-[800px] 2xl:h-[900px] 2xl:w-[900px] mt-4 justify-center overflow-hidden blur-[3px]">
                    {/* imagen del bg */}
                ...
                {/* icono del rol */}
                <img src={agent.role.displayIcon} alt={agent.role.displayName} width={82} className="absolute hidden lg:block  lg:left-[83%] lg:top-24 2xl:left-[76%] 2xl:bottom-[78%] drop-shadow-[2px_2px_2px_rgba(0,0,0,1)]" />
                ...
                <div style={{ background: fillColor }} className="shadow-md">
                ...
                <div className="absolute top-[62%] left-8 md:top-[80%] lg:left-3 lg:top-[75%] 2lg:top-[75%] xl:left-8 xl:top-[75%] 2xl:left-[260px] 2xl:top-[78%] lg:p-6 z-30">
                    <div className="flex flex-row items-center gap-x-4">
                        ...
                        <img src={agent.role.displayIcon} alt={agent.role.displayName} width={22} className="block lg:hidden drop-shadow-[5px_2px_2px_rgba(0,0,0,1)] " />
                    </div>
